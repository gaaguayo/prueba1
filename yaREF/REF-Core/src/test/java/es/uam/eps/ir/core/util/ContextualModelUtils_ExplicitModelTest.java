 ...
 * @author pedro
 */
public class ContextualModelUtils_ExplicitModelTest extends TestCase {
    final ModelIF<Object, Object, ContinuousTimeContextIF> model;
    
    public ContextualModelUtils_ExplicitModelTest(String testName) {
        super(testName);
        model = new GenericExplicitModel<Object, Object, ContinuousTimeContextIF>(); // equal number of preferences per user is required, for automated tests
        model.addPreference(1, 1, (float)1, new ContinuousTimeContext((long)100000000));
        model.addPreference(1, 1, (float)5, new ContinuousTimeContext((long)200000000));
        model.addPreference(1, 5, (float)1, new ContinuousTimeContext((long)250000000));
        model.addPreference(1, 5, (float)3, new ContinuousTimeContext((long)280000000));
        model.addPreference(2, 3, (float)3, new ContinuousTimeContext((long)150000000));
        model.addPreference(2, 3, (float)4, new ContinuousTimeContext((long)200000000));
        model.addPreference(2, 5, (float)3, new ContinuousTimeContext((long)260000000));
        model.addPreference(2, 5, (float)5, new ContinuousTimeContext((long)300000000));
    }
