 ...
 */
public class ItemUserOverallMean<U,I,C extends ContextIF> implements RecommenderIF<U,I,C>{
    ContextualModelUtils<U,I,C> utils;

    public ItemUserOverallMean(ModelIF<U,I,C> model) {
    ...
    public Float predict(U user, I item, C context) {
        ...
        if (Float.isNaN(prediction)){
            prediction = utils.getMeanRating();
        }
        return prediction;
    }
