 ...
 * @author pedro
 */
public class PeriodOfDayAttributeComputer3<C extends ContinuousTimeContext> extends AbstractTimeContextAttributeComputer<C> implements ContextualAttributeComputerIF<C>{
