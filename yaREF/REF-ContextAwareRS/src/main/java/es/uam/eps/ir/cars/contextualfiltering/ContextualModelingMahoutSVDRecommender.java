 ...
 * @author pedro
 */
public class ContextualModelingMahoutSVDRecommender <U,I,C extends ContextIF> extends AbstractRecommender<U,I,C> implements RecommenderIF<U,I,C>,ContextDependentIF{
    ...
    private int numIterations;
        ...
        public ContextualModelingMahoutSVDRecommender(ModelIF<U, I, C> originalModel, ContextualSlicerIF<U,I,C> slicer, int numFeatures, int numIterations) {
    ...
    public Float predict(U user, I item, C context) {
        ...
        if (contextContextualuserMap==null) { return Float.NaN;}
        String contextualuser = contextContextualuserMap.get(segment);
