 ...
 */
public class ContextualPostFilteringMahoutUserRatingRecommender<U,I,C extends ContextIF> extends AbstractRecommender<U,I,C> implements RecommenderIF<U,I,C>,ContextDependentIF{
    ...
    public ContextualPostFilteringMahoutUserRatingRecommender(ModelIF<U,I,C> model, ContextualSlicerIF<U,I,C> slicer, int neighbors) {
        this.slicer=slicer;
