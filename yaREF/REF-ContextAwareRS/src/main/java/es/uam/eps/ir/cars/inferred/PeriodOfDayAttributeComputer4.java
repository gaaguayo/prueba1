 ...
 * @author pedro
 */
public class PeriodOfDayAttributeComputer4<C extends ContinuousTimeContextIF> extends AbstractTimeContextAttributeComputer<C> implements CategoricalContextComputerIF<C>{
