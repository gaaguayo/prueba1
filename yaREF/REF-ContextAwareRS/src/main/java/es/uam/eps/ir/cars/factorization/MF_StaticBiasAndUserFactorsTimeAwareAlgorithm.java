...
public class MF_StaticBiasAndUserFactorsTimeAwareAlgorithm<U,I,C extends ContinuousTimeContextIF> extends AbstractFactorizationAlgorithm<U,I,C>{
    ...
    public void trainBias(int userIndex, int itemIndex, PreferenceIF<U,I,C> pref, double err){
        ...
        theModel.setUserBias( userIndex, userBias + theModel.getLRStaticBias() * (err - theModel.getLambdaStaticBias() * userBias) );
        theModel.setItemBias( itemIndex, itemBias + theModel.getLRStaticBias() * (err - theModel.getLambdaStaticBias() * itemBias) );        
    }
