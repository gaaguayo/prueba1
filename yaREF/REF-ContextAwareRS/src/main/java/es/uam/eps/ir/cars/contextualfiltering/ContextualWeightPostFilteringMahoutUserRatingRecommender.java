 ...
 */
public class ContextualWeightPostFilteringMahoutUserRatingRecommender<U,I,C extends ContextIF> extends ContextualPostFilteringMahoutUserRatingRecommender{
    private static final Logger logger = Logger.getLogger("ExperimentLog");

    public ContextualWeightPostFilteringMahoutUserRatingRecommender(ModelIF<U,I,C> model, ContextualSlicerIF<U,I,C> slicer, int neighbors) {
