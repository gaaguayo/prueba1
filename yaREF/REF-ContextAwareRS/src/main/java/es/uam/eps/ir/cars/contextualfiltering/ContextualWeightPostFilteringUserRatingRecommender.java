 ...
 */
public class ContextualWeightPostFilteringUserRatingRecommender<U,I,C extends ContextIF> extends ContextualPostFilteringUserRatingRecommender{
    private static final Logger logger = Logger.getLogger("ExperimentLog");

    public ContextualWeightPostFilteringUserRatingRecommender(ModelIF<U,I,C> model, ContextualSlicerIF<U,I,C> slicer, int neighbors) {
