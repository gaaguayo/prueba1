 ...
 */
public class ContextualFilterPostFilteringUserRatingRecommender<U,I,C extends ContextIF> extends ContextualPostFilteringUserRatingRecommender{
    private static final Logger logger = Logger.getLogger("ExperimentLog");

    public ContextualFilterPostFilteringUserRatingRecommender(ModelIF<U,I,C> model, ContextualSlicerIF<U,I,C> slicer, int neighbors) {
