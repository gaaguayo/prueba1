 ...
 */
public class ContextualFilterPostFilteringMahoutSVDRecommender_Neighbors<U,I,C extends ContextIF> extends ContextualPostFilteringMahoutSVDRecommender_Neighbors{
    private static final Logger logger = Logger.getLogger("ExperimentLog");

    public ContextualFilterPostFilteringMahoutSVDRecommender_Neighbors(ModelIF<U,I,C> model, ContextualSlicerIF<U,I,C> slicer, int neighbors, int numFeatures, int numIterations) {
