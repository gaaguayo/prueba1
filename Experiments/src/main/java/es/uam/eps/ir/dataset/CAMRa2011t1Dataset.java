 ...
 * @author pedro
 */
public class CAMRa2011t1Dataset<U,I,C extends ContinuousTimeContextIF> extends AbstractDataset<U,I,C> implements DatasetIF<U,I,C>{

    public CAMRa2011t1Dataset(String path, String file) {
        super(path, file);
    }
    
    public CAMRa2011t1Dataset(String[] args) {
        super(args);
    }
    

    public CAMRa2011t1Dataset() {
        super();
    }
