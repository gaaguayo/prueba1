 ...
 * @author pedro
 */
public class TV2Dataset<U,I,C extends ContinuousTimeContextIF> extends AbstractDataset<U,I,C> implements DatasetIF<U,I,C>{

    public TV2Dataset(String path, String file) {
        super(path, file);
    }
    
    public TV2Dataset(String[] args) {
        super(args);
    }
