 ...
 * @author pedro
 */
public class Movielens1m_TFMSplit5Dataset<U,I,C extends ContinuousTimeContextIF> extends AbstractDataset<U,I,C> implements DatasetIF<U,I,C>{

    public Movielens1m_TFMSplit5Dataset(String path, String file) {
        super(path, file);
    }
    
    public Movielens1m_TFMSplit5Dataset(String[] args) {
        super(args);
    }
    

    public Movielens1m_TFMSplit5Dataset() {
        super();
    }
