 ...
 * @author pedro
 */
public class CAMRa2011t1hhDataset<U,I,C extends ContinuousTimeContextIF> extends AbstractDataset<U,I,C> implements DatasetIF<U,I,C>{

    public CAMRa2011t1hhDataset(String path, String file) {
        super(path, file);
    }
    
    public CAMRa2011t1hhDataset(String[] args) {
        super(args);
    }
    

    public CAMRa2011t1hhDataset() {
        super();
    }
