 ...
 * @author pedro
 */
public class Movielens1m_TFMSplit5_validationDataset<U,I,C extends ContinuousTimeContextIF> extends AbstractDataset<U,I,C> implements DatasetIF<U,I,C>{

    public Movielens1m_TFMSplit5_validationDataset(String path, String file) {
        super(path, file);
    }
    
    public Movielens1m_TFMSplit5_validationDataset(String[] args) {
        super(args);
    }
    

    public Movielens1m_TFMSplit5_validationDataset() {
        super();
    }
    ...
    public final String name(){
        return "MovieLens1m_TFMSplit5_validation";
    }    
}
