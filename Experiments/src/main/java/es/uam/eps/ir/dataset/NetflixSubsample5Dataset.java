 ...
 * @author pedro
 */
public class NetflixSubsample5Dataset<U,I,C extends ContinuousTimeContextIF> extends AbstractDataset<U,I,C> implements DatasetIF<U,I,C>{
    private final int sample = 5;

    public NetflixSubsample5Dataset(String path, String file) {
        super(path, file);
    }
    
    public NetflixSubsample5Dataset(String[] args) {
        super(args);
    }
    

    public NetflixSubsample5Dataset() {
        super();
    }
