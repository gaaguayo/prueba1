 ...
 * @author pedro
 */
public class CAMRa2011FullDataset<U,I,C extends ContinuousTimeContextIF> extends AbstractDataset<U,I,C> implements DatasetIF<U,I,C>{

    public CAMRa2011FullDataset(String path, String file) {
        super(path, file);
    }
    
    public CAMRa2011FullDataset(String[] args) {
        super(args);
    }
    

    public CAMRa2011FullDataset() {
        super();
    }
