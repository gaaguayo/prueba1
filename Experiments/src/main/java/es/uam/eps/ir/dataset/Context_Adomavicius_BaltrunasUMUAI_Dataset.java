 ...
 * @author pedro
 */
public class Context_Adomavicius_BaltrunasUMUAI_Dataset<U,I,C extends ContextIF> extends AbstractDataset<U,I,C> implements ContextualDatasetIF<U,I,C>{

    public Context_Adomavicius_BaltrunasUMUAI_Dataset(String path, String file) {
        super(path, file);
    }
    
    public Context_Adomavicius_BaltrunasUMUAI_Dataset(String[] args) {
        super(args);
    }
    

    public Context_Adomavicius_BaltrunasUMUAI_Dataset() {
        super();
    }
    ...
    protected final void setReader(){
        ...
        theReader.addContext("year", 5, Arrays.asList("2000","2001","2002"));
        ...
        theReader.addContext("will_recommend", 9, Arrays.asList("1","2","3")); //1:"release",2:"non_release",3:"undefined"
        theReader.addContext("where", 10, Arrays.asList("1","2","3")); //1:"theater",2:"home",3:"undefined"
