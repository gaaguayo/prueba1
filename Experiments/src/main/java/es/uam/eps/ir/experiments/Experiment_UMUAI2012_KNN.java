 ...
 *
 */
public class Experiment_UMUAI2012_KNN 
{
    // Dataset
    final static CommonDatasets.DATASET dataset_name = CommonDatasets.DATASET.NetflixSubsample1;
    ...
    final static CommonRecommenders.METHOD       recommender_method  = CommonRecommenders.METHOD.kNN_PearsonWeightedSimilarity_UserBased;
    final static int neighbors = 201;

    // Parallel processor?
    final static boolean useParallelProcessor = true;
    ...
    final static boolean SAVE_DETAILED_RESULTS = false;
...
//        System.exit(0);
        ...
        for (SplitIF<Object, Object, ContinuousTimeContextIF> split:splits){
            ...
            EXPERIMENT_PREFIX = datasetString + "-test__"  + recommender_method + "__" + splitter + candidates + "_threshold=" + relevance_threshold + "__" + filterer.getFilters()  + "__";
